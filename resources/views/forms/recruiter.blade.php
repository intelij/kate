<form method="POST" action="{{ route('register') }}">
    ...
    <input id="is_candidate" type="hidden" class="form-control" name="is_candidate" value="0" required autocomplete="is_candidate" >
    <input id="is_recruiter" type="hidden" class="form-control" name="is_recruiter" value="1" required autocomplete="is_recruiter" >
